        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card post-card h-100 shadow-sm rounded overflow-hidden">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <span><?= $post['user']['username'] ?> · <?= date("M d, Y", strtotime($post['created_at'])) ?></span>
                    <span>
        ...
        <nav aria-label="Posts navigation">
            <ul class="pagination justify-content-center">
                <li class="page-item <?= ($this->currentPage <= 1) ? 'disabled' : '' ?>">
                    <a class="page-link" href="<?= ($this->currentPage <= 1) ? '#' : '?page=' . ($this->currentPage - 1) ?>" aria-label="Previous">&laquo;</a>
                </li>
                ...
                <li class="page-item <?= ($this->currentPage >= $this->totalPages) ? 'disabled' : '' ?>">
                    <a class="page-link" href="<?= ($this->currentPage >= $this->totalPages) ? '#' : '?page=' . ($this->currentPage + 1) ?>" aria-label="Next">&raquo;</a>
                </li>
            </ul>
        </nav>
    </div>
