    ...
    <section class="vh-100" style="background-color: #eee;">
        <div class="container-fluid h-custom">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <form action="<?php echo AppUtil::url(array('ctl' =>'auth', 'act' => 'login')); ?>" method="POST">
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        ...
                        style="padding-left: 2.5rem; padding-right: 2.5rem;" name="btn_submit">Login</button>
                        <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="<?php echo AppUtil::url(array('ctl' =>'auth', 'act' => 'register')); ?>"
