...
<head>
    ...
    <title>MBlog - Register</title>
    <link rel="icon" type="image/x-icon" href="<?php echo RootREL;?>media/img/favicon.png">
            ...
            <div class="col-lg-12 col-xl-11">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                        <p class="text-center h1 fw-bold mx-1 mx-md-4 mb-3" id="title"><span>S</span>ign up</p>
                        <form class="mx-1 mx-md-4" method="POST" action="<?php echo AppUtil::url(['ctl' => 'auth', 'act' => 'register']); ?>">
                            ...
                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                <button  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" name="btn_submit">Register</button>
                            </div>
                        </form>
