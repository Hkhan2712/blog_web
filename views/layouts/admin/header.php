...
<head>
    ...
    <link rel="stylesheet" href="<?=RootREL?>media/admin/css/header.css">
    <link rel="stylesheet" href="<?=RootREL?>media/admin/css/footer.css">
</head>
<body>
<header>
...
<div>
    <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px; height: 100vh;">
        <a href="" class="navbar-brand navbar-brand__admin d-flex justify-content-center"><span class="navbar-brand__head">M</span>Blog</a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto d-flex flex-column gap-2">
            <li class="nav-item">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-black text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <strong>Nguyen Tuan Kiet</strong>
            </a>
