...
<main>
<div class="d-flex">
    <div class="d-flex flex-column flex-shrink-0 p-3" style="max-width:280px; height: 100vh;">
        ...
        <ul class="nav nav-pills flex-column mb-auto d-flex flex-column gap-2">
            <li>
                <a href="#" class="nav-link active d-flex gap-2 align-items-center">
            ...
            <li>
                <a href="#" class="nav-link d-flex gap-2 align-items-center">
