...
<header>
    <nav class="container navbar navbar-expand-lg d-flex justify-content-around gap-3">
        ...
        <div class="d-flex gap-4 align-items-center">
            ...
            <!-- thay doi la account, neu chua log in thi login, nguoc lai hien thi icon account -->
            ...
            <a href="<?php echo AppUtil::url(array('ctl' =>'auth', 'act' => 'register')); ?>" class="btn btn-primary">Sign Up</a>
        </div>
    </nav>
