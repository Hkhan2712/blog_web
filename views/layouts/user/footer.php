<footer class="container"> 
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 my-5 border-top"> 
        ...
        <div class="col mb-3"> 
            ...
            <ul class="nav flex-column"> 
                <li class="nav-item mb-2">
                    <a href="#" class="nav-link p-0">Technology</a>
                </li> 
                <li class="nav-item mb-2">
                    <a href="#" class="nav-link p-0">Travel</a>
                </li> 
                <li class="nav-item mb-2">
                    <a href="#" class="nav-link p-0">Lifestyle</a>
                </li> 
                <li class="nav-item mb-2">
                    <a href="#" class="nav-link p-0">Economy</a>
                </li> 
                <li class="nav-item mb-2">
                    <a href="#" class="nav-link p-0">History</a>
                </li> 
            </ul> 
        </div> 
        <div class="col mb-3"> 
            ...
            <ul class="nav flex-column"> 
                ...
                <li class="nav-item mb-2">
                    <a href="#" class="nav-link p-0">Terms of service</a>
                </li> 
                <li class="nav-item mb-2">
