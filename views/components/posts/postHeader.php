    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="infor-detail d-flex gap-3">
            <div class="time d-flex gap-1 align-items-center">
                ...
                <p class="m-0"><?= date('d/m/Y', strtotime($data['post']['created_at'])) ?></p>
            </div>
            ...
            <div class="comments d-flex gap-1 align-items-center">
                ...
                <p class="m-0" id='comment-count'><?= (int)$data['post']['comment_quantity'] ?></p>
            </div>
        </div>
        <button 
            id="like-btn"
            ...
            onclick="LikeModule.toggleLike(<?= $data['post']['id']?>, 'post', this)"
            <?= !$isLoggedIn ? 'disabled' : '' ?>
        >
            ...
            <span class="ms-1" id="like-count"><?= (int)$data['post']['like_quantity'] ?></span>
        </button>
    </div>
</div>