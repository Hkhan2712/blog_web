    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="infor-detail d-flex gap-3">
            ...
            <div class="like-count d-flex gap-1 align-items-center">
                ...
                <p class="m-0" id='like-count'><?= (int)$post['like_quantity'] ?></p>
            </div>
        </div>
        <button 
            id="like-btn"
            class="btn d-flex gap-1 align-items-center <?= $isLiked ? 'btn-primary' : 'btn-outline-primary' ?>"
            onclick="<?= $isLoggedIn && !$isLiked ? 'CommentModule.likePost(' . (int)$post['id'] . ')' : '' ?>"
            <?= !$isLoggedIn || $isLiked ? 'disabled' : '' ?>
        >
