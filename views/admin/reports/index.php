<?php
global $mediaFiles;
array_push($mediaFiles['css'], RootREL.'media/admin/css/main.css');
?>
<?php include_once "views/layouts/admin/header.php" ?>
<div class="w-100 d-flex flex-column dashboard">
    <div class="navbar bg-body-tertiary">
        <div class="container gap-3 justify-content-end">
            <form class="d-flex form-inline my-2 my-lg-0 gap-1">
                <input class="form-control mr-sm-2" type="search" placeholder="Search on MBlog" aria-label="Search">
    ...
    <div class="container d-flex justify-content-between align-items-center">
        <h1 class="p-2">Report Management</h1>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex gap-1">
                                <a href="#view" class="btn btn-outline-info table-link view" data-toggle="modal">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                        <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z"/>
                                        <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
                                    </svg> 
                                </a>
                                <a href="#edit" class="btn btn-outline-info table-link edit" data-toggle="modal">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                        <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001"/>
                                    </svg>
                                </a>
                                <a href="#delete" class="btn btn-outline-info table-link delete" data-toggle="modal">
