<?php
class UserModel extends FrapModel {
    public $nopp = 10;
    public static $avatarUrl = UploadREL."users/";
    ...
    public static function getAvatarUrl() {
        return RootURL.self::$avatarUrl.$_SESSION['user']['avartar'];
    }
